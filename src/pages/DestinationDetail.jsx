  ...
  return (
    <div style={{
      ...
      <div className="action-buttons" style={{ display: 'flex', gap: 18, marginBottom: 22 }}>
        ...
        <button style={{ background: 'none', border: 'none', fontSize: 15, fontWeight: 600, textDecoration: 'underline', cursor: 'pointer', position: 'relative', color: '#1E90FF' }} onClick={() => alert('Showing all photos gallery')}>Show all photos</button>
      </div>
      {/* Image Gallery */}
      <div className="image-gallery" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gridTemplateRows: '1fr 1fr', gap: 10, height: 400, marginBottom: 24, borderRadius: 16, overflow: 'hidden', boxShadow: '0 2px 12px #1e90ff22' }}>
        ...
        <div className="secondary-image show-all-photos" style={{ backgroundSize: 'cover', backgroundPosition: 'center', backgroundImage: `url('${images[3]}')`, position: 'relative', cursor: 'pointer' }} onClick={() => alert('Showing all photos gallery')}>
      ...
      <div className="reviews" style={{ marginBottom: 30 }}>
        ...
        {reviews.map((r, idx) => (
          <div key={idx} className="review-item" style={{ marginBottom: 20 }}>
            ...
            <p className="show-more" style={{ color: '#1E90FF', fontWeight: 500, textDecoration: 'underline', cursor: 'pointer' }} onClick={() => alert(r.text)}>Show more</p>
          </div>
        ))}
      </div>
